 ...
 * @author BaPhuoc
 */
public class DateTimeCheckerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
          LocalDate.of(year, month, day);
            ...
            request.setAttribute("isValidDate", isValidDate);
            RequestDispatcher rd = request.getRequestDispatcher("checkDate.jsp");
